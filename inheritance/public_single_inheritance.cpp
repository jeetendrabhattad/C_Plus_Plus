...
// if inheritance is public:- whatever is public in Base remains public in Derived, whatever is protected in Base remains protected in Derived, whatever is private in Base remains private & not accessible in Derived
{
	int c;
	int d;
	protected:
	...
	void Display(){
		...
		std::cout<<": "<<":"<<iSkoda<<":"<<iMaruti<<std::endl;
	}
};
